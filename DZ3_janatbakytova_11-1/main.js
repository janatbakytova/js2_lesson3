  ...
  productsId.innerHTML += `
            <div class="col-lg-3 mb-3">
                <div class="product">
                    ...
                    <button 
                        class="product__basket-remove-btn" 
                        data-id=${product.id} 
                        data-name=${product.name} 
                        data-price=${product.price}
                    >
...
const addBasketBtns = document.querySelectorAll(".product__basket-add-btn");
const removeFromBasketBtns = document.querySelectorAll(".product__basket-remove-btn");
